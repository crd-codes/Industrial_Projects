...
import com.crd.edutrack.Service.BatchEntryService;
...
public class BatchEntryController
{
    ...
    // Create a new batch entry (URL: http://localhost:8080/batches)
    @PostMapping
    ...
    // Fetch all batches (URL: http://localhost:8080/batches)
    @GetMapping
    ...
    // Update existing batch details (URL: http://localhost:8080/batches/id/{batchId})
    @PutMapping("id/{myid}")
    ...
    // Delete batch by ObjectId (URL: http://localhost:8080/batches/id/{batchId})
